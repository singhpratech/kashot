...
Files reference `v0.3.11` and use placeholder `REPLACE_WITH_ACTUAL_SHA256_AT_RELEASE_TIME`
...
> are buildable as-is against the v0.3.11 release tarball, but neither is
