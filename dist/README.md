...
Files reference `v0.3.4` and use placeholder `REPLACE_WITH_ACTUAL_SHA256_AT_RELEASE_TIME`
...
> **Windows artifacts.** As of v0.3.4 the Release ships both
...
> are buildable as-is against the v0.3.4 release tarball, but neither is
